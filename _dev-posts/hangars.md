---
title: Ангары
status: "Обновлено: 23 февраля 2025 года"
...
{% include indev/status.html status="doe" text="Масштабные переработки" date="23 февраля" %}
...
### Ангары второго поколения

Данные изменения включены в базовый и премиум ангары.
- Пересоздана база ангара.
- Все источники освещения перенесены с оригинальными значениями и почти не подвергались изменениям.
- Декали теперь сделаны на старом шейдере и без изменений перетекли в ангар.
- Освещение скорректировано.
- Перестановка некоторых объектов.
