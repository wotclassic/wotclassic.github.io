...
![1]({{ '/assets/img/news/screens/hp082.png' | relative_url}}){: .fancy-img}
![2]({{ '/assets/img/news/screens/h082.png' | relative_url}}){: .fancy-img}
...
![1]({{ '/assets/img/news/screens/ssb_lake2.png' | relative_url}}){: .fancy-img}
![2]({{ '/assets/img/news/screens/ssb_proh2.png' | relative_url}}){: .fancy-img}

### SD-модели

Мы активно ведем разработку веток США и Германии. Также мы не могли обойти стороной доработку и пополнение машин СССР.

![1]({{ '/assets/img/news/screens/sd-company.png' | relative_url}}){: .fancy-img width="100%" }
...
![1]({{ '/assets/img/news/screens/ui_bat.png' | relative_url}}){: .fancy-img}
...
![1]({{ '/assets/img/news/screens/old_header.png' | relative_url}}){: .fancy-img}

Также изменениям подверглась вкладка "Исследования", теперь вы можете увидеть здесь то, что происходит в ангаре!

![2]({{ '/assets/img/news/screens/techtree.png' | relative_url}}){: .fancy-img}
![3]({{ '/assets/img/news/screens/research.png' | relative_url}}){: .fancy-img}
