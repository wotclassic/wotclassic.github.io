...
![1]({{ '/assets/img/birthday/to_archives.png' | relative_url}}){: .fancy-img width="100%" }

---

![1]({{ '/assets/img/birthday/to_update.png' | relative_url}}){: .fancy-img width="100%" }
...
![1]({{ '/assets/img/birthday/home1.png' | relative_url}}){: .fancy-img}
![2]({{ '/assets/img/birthday/home2.png' | relative_url}}){: .fancy-img}
![3]({{ '/assets/img/birthday/home3.png' | relative_url}}){: .fancy-img}
