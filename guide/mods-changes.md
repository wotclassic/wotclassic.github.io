...
<img class="pic-left fancybox-gallery-wot fancybox-image" title="ui" src="/assets/img/guide/screens/gamepage1.jpg" alt="Skybox" width="243">
...
[![скрин2]({{ '/assets/img/archive/login2.2-load.png' | relative_url}}){: width="100%" }](/assets/img/archive/login2.2-load.png)
[![логин]({{ '/assets/img/guide/newcomers/login.png' | relative_url}}){: width="100%" }](/assets/img/guide/newcomers/login.png)
...
[![интерфейс ангара]({{ '/assets/img/guide/newcomers/hangar_ui.png' | relative_url}}){: width="100%" }](/assets/img/guide/newcomers/hangar_ui.png)
...
[![загрузка]({{ '/assets/img/guide/newcomers/load_ui.png' | relative_url}}){: width="100%" }](/assets/img/guide/newcomers/load_ui.png)

- Шапка боя
- Счетчик FPS и пинга
- Таймер до окончания боя
- Отсчетчик до начала боя
- Панель снаряжения
- Миникарты
- Уши команды
- Панель повреждений
...
[![бой]({{ '/assets/img/guide/newcomers/battle_ui.png' | relative_url}}){: width="100%" }](/assets/img/guide/newcomers/battle_ui.png)

---

### Ангары
<img class="pic-left fancybox-gallery-wot fancybox-image" title="hangars" src="/assets/img/guide/newcomers/hangar_premium_v2.png" alt="Skybox" width="243">
...
[![ангар]({{ '/assets/img/indev/screens/h2.png' | relative_url}}){: width="100%" }](/assets/img/indev/screens/h2.png)
...
[![ангар прем]({{ '/assets/img/indev/screens/hp1.png' | relative_url}}){: width="100%" }](/assets/img/indev/screens/hp1.png)
...
[![ангар 9.х]({{ '/assets/img/guide/newcomers/hangar_premium_v2.png' | relative_url}}){: width="100%" }](/assets/img/guide/newcomers/hangar_premium_v2.png)

---

### Изменения на картах
<img class="pic-left fancybox-gallery-wot fancybox-image" title="maps" src="/assets/img/guide/screens/gamepage1.jpg" alt="Skybox" width="243">
...
### Старые звуки
<img class="pic-left fancybox-gallery-wot fancybox-image" title="sounds" src="/assets/img/guide/screens/gamepage1.jpg" alt="Skybox" width="243">
