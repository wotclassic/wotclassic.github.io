...
В «TO это Классика!» существует десять ностальгических модов. Выбрать каждый мод можно в [соответствующем]({{ "/mods" | relative_url }}) разделе. Здесь вы узнаете какие моды отвечают за те или иные изменения клиента Tanki Online.
...
Интерфейс - самая важная часть Tanki Online, благодаря нему вы понимаете множество полезной информации. Но в последнее время там появляется множество мусора, поэтому мы готовы хоть неменого вернуть вам тот самый интерфейс, компактный и удобный.
...
Игра начинается с игрового интерфейса. Мод на «[Старый интерфейс ангара](https://drive.google.com/drive/folders/1Bv_BxHXXZtcuftR0zf5U_wzCYpRENtWl?usp=sharing)» частично возвращает ангарный интерфейс из прошлых обновлений игры схожей тематики. На момент написание статьи изменены:
...
Мод основывается на версии 0.8.2 игры схожей тематики и вот список изменений:
...
При входе в Tanki Online, игроки всегда оказываются в знакомой обстановке: танк стоит в футуристичном ангаре с необычными устройствами вокруг.
Именно так выглядит ангар в наше время. Но моды «TO это Классика!» возвращают Вам те самые ангары из игры схожей тематики, которые помогали еще больше расслабиться, и напоминали вам в какую игру Вы играете, так давайте посмотрим на них поближе!
...
[Карты](https://tanki.su/ru/content/guide/map-guides/) являются неотъемлемой частью игры схожей тематики, и после обновления 1.0 они были кардинально [переработаны](https://tanki.su/ru/news/common/maps10part1/) в HD-версию.
Моды серии «TO это Классика!» возвращают на эти карты ощущение войны, которые было присуще старым версиям игры схожей тематики.

<br><br><br><br><br>

#### Старые скайбоксы

Многие из Вас помнят закат на Мурованке или ярко палящее солнце на Эль-Халлуфе (карты из игры схожей тематики), но теперь всё это сменили на яркие и красочные цвета. Мод на старые скайбоксы поможет вернуть Вам то родное и знакомое небо вместе с освещением, которым оно было до обновления 1.0. Данный мод заменяет более **30** игровых карт! А именно:
...
Звуковая модификация из серии модов "TO это Классика!", позволяющая на собственных ушах ощутить тарахтение двигателей тогдашних танков, [гром](https://kr.cm/f/t/62100/)ыхание выстрелов, лязг гусениц и прочие до боли знакомые настоящим олдам звуки.
