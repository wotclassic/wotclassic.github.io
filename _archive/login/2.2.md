...
![скрин1]({{ '/assets/img/archive/login2.2-gret.png' | relative_url}}){: .fancy-img width="100%" }
![скрин2]({{ '/assets/img/archive/login2.2-load.png' | relative_url}}){: .fancy-img width="100%" }
