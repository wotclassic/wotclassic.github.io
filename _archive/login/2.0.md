...
![скрин1]({{ '/assets/img/archive/login2.0-1.jpg' | relative_url}}){: .fancy-img width="100%" }
![скрин2]({{ '/assets/img/archive/login2.0-2.jpg' | relative_url}}){: .fancy-img width="100%" }
![скрин1]({{ '/assets/img/archive/login2.0-3.jpg' | relative_url}}){: .fancy-img width="100%" }
